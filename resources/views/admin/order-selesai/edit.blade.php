...
@section('content')
    @if (session('success'))
        <div class="alert alert-light-success color-success"><i class="bi bi-check-circle"></i>
            Orderan Berhasil Diterima Oleh Customer.
        </div>
    @endif
    @if ($order)
        <section class="row">
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-3 text-end">
                            <a href="{{ route('admin.order.selesai.show') }}" class="btn btn-primary"><i class="fas fa-arrow-left"></i> Kembali</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form method="POST">
                        <div class="row">
                            ...
                            <div class="col-12 col-xl-6">
                                ...
                                @if ($order->is_taken != 'yes')
                                    <div class="form-group">
                                        <button type="submit" class="form-control btn btn-primary"
                                            formaction="{{ route('admin.order.selesai.diterima', $order->id) }}">Orderan Diterima</button>
                                    </div>
                                @endif
                            </div>
                    </form>
